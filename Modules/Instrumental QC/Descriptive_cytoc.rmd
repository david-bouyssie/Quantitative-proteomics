...
output:
  html_document
params:
  file_name : "../../Data/CytoC/Rapport/cytoc_xics_ref.csv"
---
...
#input = read.table("../../Data/CytoC/Dusan/20190321_QC_cytoc_xics.csv",sep=",",header=T)

# Labels for legend
input$Precursors = paste0(input$Precursor,"\n (",input$mz,")")

# To order X axis by date
...
# Display plots next to each other or not
layout = length(unique(input$AcquiredTime)) < 0
```
...
# if (layout==T){
#   grid.arrange(arrangeGrob(gg1), arrangeGrob(gg2),ncol=2,nrow=1,respect=TRUE) 
# }else{
#   plot(gg1+theme(plot.margin = unit(c(2,0,2,0), "cm")))
#   plot(gg2)
# }
