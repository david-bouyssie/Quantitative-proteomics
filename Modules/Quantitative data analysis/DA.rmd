...
params:
  ...
  design_exp: "D:/Utilisateurs/cludwig/stage/RStudio/Tests/Data/Quanti/Parsed_data/Human_yeast/designExp.txt"
  parameters: "D:/Utilisateurs/cludwig/stage/RStudio/Tests/Data/Quanti/Parsed_data/Human_yeast/Params_da.txt"
  output_table: "..."
...
#message(paste0("ncol filtered_data",ncol(filtered_data)))
...
for (comparison in comparisons_to_do){
  ...
  if(as.logical(parameters["Test.paired",])){
    ...
    #totIntensities[paste0("fc_",comparison)] = 2^(totIntensities[paste0("mean_intensity_",A_name)]-totIntensities[paste0("mean_intensity_",B_name)])
      ...
      #message(names(totIntensities)) ### Added by DBO ###
      #message(grepl(paste0(A_name,"_mean_imputed"),names(totIntensities))) ### Added by DBO ###
      #message(grepl(paste0(B_name,"_mean_imputed"),names(totIntensities))) ### Added by DBO ###
