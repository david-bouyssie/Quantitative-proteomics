...
for (comparison in comparisons_to_do){
  ...
  if(parameters["Test.adjust.procedure",]!="none"){
    value="qval"
    procedure_results = mt.rawp2adjp(as.numeric(unlist(statDF[paste0("pval_",comparison)])),
                                     proc=as.character(parameters["Test.adjust.procedure",]), alpha=parameters["Test.adjust.FDR",])
