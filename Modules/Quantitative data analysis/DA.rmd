...
#install.packages("../../../Package/quantitativeProteomics_0.0.0.9000.tar.gz", repos = NULL, type="source")
#library(quantitativeProteomics)
...
```{r specific_peptides, results='asis'}
