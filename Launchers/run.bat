...
:: Example :
::Rscript --vanilla run_proteomics_stats.R QC "../../Example/Datasets/Parsed_proteins_set.txt" "../../Example/Reports/QC_example.html" TRUE FALSE
...
:: Example :
Rscript --vanilla run_proteomics_stats.R DA "../../Example/Datasets/Parsed_proteins_set.txt" "../../Example/Reports/DA_example.html" "../../Example/Reports/DA_example.txt" "../../Example/Datasets/designExp.txt" "../../Example/Datasets/Parameters.txt"
